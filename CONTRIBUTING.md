...
- Go to the [Flamingock Examples GitHub repository](https://github.com/flamingock/flamingock-java-examples).
...
```shell
git clone https://github.com/YOUR_USERNAME/flamingock-java-examples.git
